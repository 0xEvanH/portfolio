...
const experiences: ExperienceItem[] = [
  {
    ...
    bullets: [
      "Designed and shipped an internal data tracking dashboard in Python with Streamlit, organising OKRs from Jira into a single unified view.",
      "Displayed the data in clear graphs with filters for quarters and years.",
      "Allowed them to save money, rather than paying for a subscription to show investors and higher-ups.",
  ...
  },
  {
    ...
    type: "internship",
    accent: "#5b8def",
    headline: "Automated app testing for a Web3 token management platform.",
    bullets: [
      "Built a full automated testing suite using Playwright covering critical user flows across the Hedgey token vesting and locking application.",
